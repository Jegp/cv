...
Courses: Machine learning, Neuroscience, Computer vision, Philosophy of Science, Supervision, Communication, and Teaching \\
...
I was highly praised, and received outstanding reviews, for my pedagogical skills and ability to translate complex academic subjects.\\
\years{2016-2019}\textbf{Chief Technology Officer}, Mobilized Construction, Denmark, Kenya\\
I designed and implemented a globally distributed software stack, managed teams in the US, Wales, Kazaksthan, and Kenya, and supervised projects from the University of Southern California and the University of Waterloo.\\
...
\years{2022}The need for neuromorphic abstractions --- 
...
\years{2021}Norse: A library for gradient-based learning in Spiking Neural Networks --- Workshop on \emph{Spiking Neural networks as Universal Function Approximators} \\
\years{2021}Deep learning with spiking neural networks in Norse ---
\emph{5th HBP Student Conference}

\section*{Honours \& awards}
\years{2022}Compute grant for Swedish National Infrastructure for Computing \\
...
\noindent
\years{2023}\textbf{Neuromorphic Intermediate Representation} --- Initiative to bridge independent neuromorphic simulators and hardware platforms (\href{https://github.com/neuromorphs/nir}{github.com/neuromorphs/nir}). \\
\years{2022}\textbf{Real-time neuromorphics with Norse and AEStream} ---
