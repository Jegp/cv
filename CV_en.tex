...
\years{2024}\textbf{J. E. Pedersen}*, S. Abreau *, J. Eshraghian, et al. (* equal authorship) ``The Neuromorphic Intermediate Representation''.
...
\years{2024} A. Geminiani, J. Kathrein, ..., \textbf{J. E. Pedersen} et al. ``Multidisciplinary and collaborative training in neuroscience: Insights from the Human Brain Project Education Programme''. \textit{Neuroinformatics}. \\
...
``CompJouleS: Energy estimate tool for Machine Learning Algorithms in CPU, GPU, and FPGA architectures.''
\textit{In review}. \\
